```
┌──(abhi㉿security)-[~/certifications/tryhackme-sal1]
└─$ cat README.md
```
...
[![TryHackMe](https://img.shields.io/badge/TryHackMe-SOC%20Level%201-212C42?style=flat&logo=tryhackme&logoColor=white)](https://tryhackme.com/p/sajjala.abhishek)
[![Platform](https://img.shields.io/badge/Platform-TryHackMe-212C42?style=flat&logo=tryhackme&logoColor=white)]()
[![Status](https://img.shields.io/badge/Status-In%20Progress-yellow?style=flat)]()
[![Level](https://img.shields.io/badge/Level-Intermediate-grey?style=flat)]()
...
Every module in this folder documents what I actually did — commands run, output captured, flags found, and an honest take on what clicked and what didn't. No course summaries. For detailed attack box walkthroughs and CTF write-ups from this path head over to the [ctf-writeups/](https://github.com/asajjala01/asajjala01/tree/main/ctf_writeups) folder.
...
> *"This is what I've been building toward. Everything else was preparation."*
